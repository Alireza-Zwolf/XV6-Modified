  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  3f:	e8 0f 03 00 00       	call   353 <find_largest_prime_factor>
    printf(1, "The largest prime factor of %d is %d\n", number, max_factor);
  44:	50                   	push   %eax
  45:	53                   	push   %ebx
  46:	68 64 07 00 00       	push   $0x764
  4b:	6a 01                	push   $0x1
...
00000353 <find_largest_prime_factor>:
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 8a 07 00 00       	mov    $0x78a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 722:	00 00 00 
    if(p->s.size >= nunits){
