...
free(void *ap)
{
 ...
 5c1:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 ac 0a 00 00    	mov    %edx,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf b0 0a 00 00       	mov    $0xab0,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 732:	00 00 00 
    if(p->s.size >= nunits){
