...
main(void)
{
  ...
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 26 08 00 00       	push   $0x826
  6c:	6a 01                	push   $0x1
  6e:	e8 5d 04 00 00       	call   4d0 <printf>
    printf(1, "3. Hadi Babaloo\n");
  73:	58                   	pop    %eax
  74:	5a                   	pop    %edx
  75:	68 39 08 00 00       	push   $0x839
  7a:	6a 01                	push   $0x1
  ...
  cc:	50                   	push   %eax
  cd:	50                   	push   %eax
  ce:	68 8c 0b 00 00       	push   $0xb8c
  d3:	68 5d 08 00 00       	push   $0x85d
  d8:	e8 ce 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  dd:	5a                   	pop    %edx
  de:	59                   	pop    %ecx
  df:	68 60 08 00 00       	push   $0x860
  e4:	6a 01                	push   $0x1
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 f8 07 00 00       	push   $0x7f8
  fa:	e8 bc 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 f8 07 00 00       	push   $0x7f8
...
00000413 <find_largest_prime_factor>:
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 7f 08 00 00       	mov    $0x87f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 94 0b 00 00       	mov    0xb94,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 94 0b 00 00    	mov    %edx,0xb94
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 94 0b 00 00    	mov    %edx,0xb94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 94 0b 00 00    	mov    0xb94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 94 0b 00 00    	mov    0xb94,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 94 0b 00 00    	mov    0xb94,%edx
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 98 0b 00 00       	mov    $0xb98,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 7e2:	00 00 00 
    if(p->s.size >= nunits){
