...
_fork_descendants:     file format elf32-i386
...
int main(void) {
  ...
  12:	68 b8 07 00 00       	push   $0x7b8
  17:	6a 01                	push   $0x1
  19:	e8 72 04 00 00       	call   490 <printf>
    int pid;
    pid = fork();
  ...
  28:	78 6d                	js     97 <main+0x97>
        printf(1 , "Fork Failed!\n");
    }
    if(pid == 0){
  2a:	75 7c                	jne    a8 <main+0xa8>
        printf(1 , "  Process : %d , Parent: %d\n", getpid() , get_parent_pid());
  2c:	e8 92 03 00 00       	call   3c3 <get_parent_pid>
  31:	89 c3                	mov    %eax,%ebx
  33:	e8 6b 03 00 00       	call   3a3 <getpid>
  38:	53                   	push   %ebx
  39:	50                   	push   %eax
  3a:	68 3f 08 00 00       	push   $0x83f
  3f:	6a 01                	push   $0x1
  41:	e8 4a 04 00 00       	call   490 <printf>
        int pid1 = fork();
  46:	e8 d0 02 00 00       	call   31b <fork>
        if(pid1 == 0){
  4b:	83 c4 10             	add    $0x10,%esp
  4e:	85 c0                	test   %eax,%eax
  50:	75 76                	jne    c8 <main+0xc8>
            printf(1 , "    Process : %d , Parent: %d\n", getpid() , get_parent_pid());
  52:	e8 6c 03 00 00       	call   3c3 <get_parent_pid>
  57:	89 c3                	mov    %eax,%ebx
  59:	e8 45 03 00 00       	call   3a3 <getpid>
  5e:	53                   	push   %ebx
  5f:	50                   	push   %eax
  60:	68 f0 07 00 00       	push   $0x7f0
  65:	6a 01                	push   $0x1
  67:	e8 24 04 00 00       	call   490 <printf>
            int pid2 = fork();
  6c:	e8 aa 02 00 00       	call   31b <fork>
            if(pid2 == 0){
  71:	83 c4 10             	add    $0x10,%esp
  74:	85 c0                	test   %eax,%eax
  76:	75 50                	jne    c8 <main+0xc8>
                printf(1 , "      Process : %d , Parent: %d\n", getpid() , get_parent_pid());
  78:	e8 46 03 00 00       	call   3c3 <get_parent_pid>
  7d:	89 c3                	mov    %eax,%ebx
  7f:	e8 1f 03 00 00       	call   3a3 <getpid>
  84:	53                   	push   %ebx
  85:	50                   	push   %eax
  86:	68 10 08 00 00       	push   $0x810
  8b:	6a 01                	push   $0x1
  8d:	e8 fe 03 00 00       	call   490 <printf>
  92:	83 c4 10             	add    $0x10,%esp
  95:	eb 2c                	jmp    c3 <main+0xc3>
        printf(1 , "Fork Failed!\n");
  97:	51                   	push   %ecx
  98:	51                   	push   %ecx
  99:	68 31 08 00 00       	push   $0x831
  9e:	6a 01                	push   $0x1
  ...
  a5:	83 c4 10             	add    $0x10,%esp
        ...
        pid = wait();
  a8:	e8 7e 02 00 00       	call   32b <wait>
        printf(1 , "Origin process: %d\n", getpid());
  ad:	e8 f1 02 00 00       	call   3a3 <getpid>
  b2:	52                   	push   %edx
  b3:	50                   	push   %eax
  b4:	68 5c 08 00 00       	push   $0x85c
  b9:	6a 01                	push   $0x1
  bb:	e8 d0 03 00 00       	call   490 <printf>
  c0:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  c3:	e8 5b 02 00 00       	call   323 <exit>
                pid2 = wait();
  c8:	e8 5e 02 00 00       	call   32b <wait>
  cd:	eb f4                	jmp    c3 <main+0xc3>
  cf:	90                   	nop
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 d0 08 00 00 	movzbl 0x8d0(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 78 08 00 00 	jmp    *0x878(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 70 08 00 00       	mov    $0x870,%edx
        while(*s != 0){
 ...
 631:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 7c 0b 00 00 80 	movl   $0xb80,0xb7c
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 80 0b 00 00       	mov    $0xb80,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 7a2:	00 00 00 
    if(p->s.size >= nunits){
