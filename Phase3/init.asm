...
main(void)
{
  ...
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 36 08 00 00       	push   $0x836
  6c:	6a 01                	push   $0x1
  6e:	e8 6d 04 00 00       	call   4e0 <printf>
    printf(1, "3. Hadi Babaloo\n");
  73:	58                   	pop    %eax
  74:	5a                   	pop    %edx
  75:	68 49 08 00 00       	push   $0x849
  7a:	6a 01                	push   $0x1
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 8f 08 00 00       	mov    $0x88f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 a4 0b 00 00       	mov    0xba4,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf a8 0b 00 00       	mov    $0xba8,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 7f2:	00 00 00 
    if(p->s.size >= nunits){
