 ...
 5b1:	a1 48 0a 00 00       	mov    0xa48,%eax
{
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 48 0a 00 00    	mov    %edx,0xa48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 48 0a 00 00    	mov    0xa48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 48 0a 00 00    	mov    0xa48,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 48 0a 00 00    	mov    0xa48,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 4c 0a 00 00       	mov    $0xa4c,%edi
    base.s.ptr = freep = prevp = &base;
