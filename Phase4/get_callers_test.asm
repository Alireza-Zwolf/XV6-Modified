...
int main(void)
{
  ...
  51:	58                   	pop    %eax
  52:	5a                   	pop    %edx
  53:	68 f7 07 00 00       	push   $0x7f7
  58:	6a 01                	push   $0x1
  5a:	e8 11 04 00 00       	call   470 <printf>
    printf(1, "process ids for SYS_wait are: ");
  5f:	59                   	pop    %ecx
  60:	58                   	pop    %eax
  61:	68 d8 07 00 00       	push   $0x7d8
  66:	6a 01                	push   $0x1
  68:	e8 03 04 00 00       	call   470 <printf>
    get_callers(3);
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba f9 07 00 00       	mov    $0x7f9,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 00 0b 00 00    	mov    %edx,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 782:	00 00 00 
    if(p->s.size >= nunits){
