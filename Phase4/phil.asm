...
int main(int argc, char **argv)
{
  ...
  14:	8b 41 04             	mov    0x4(%ecx),%eax
    ...
    phNum = atoi(argv[0]);
  17:	ff 30                	push   (%eax)
  19:	e8 d2 02 00 00       	call   2f0 <atoi>
        if (phNum % 2 == 0) {           
            ...
            semaphor_state = sem_acquire((phNum+4) % 5);
  1e:	ba 67 66 66 66       	mov    $0x66666667,%edx
        if (phNum % 2 == 0) {           
  23:	83 c4 10             	add    $0x10,%esp
            semaphor_state = sem_acquire((phNum+4) % 5);
  26:	8d 48 04             	lea    0x4(%eax),%ecx
    phNum = atoi(argv[0]);
  ...
  31:	89 c8                	mov    %ecx,%eax
        if (phNum % 2 == 0) {           
  33:	83 e7 01             	and    $0x1,%edi
            semaphor_state = sem_acquire((phNum+4) % 5);
  36:	c1 f8 1f             	sar    $0x1f,%eax
  39:	d1 fa                	sar    %edx
  3b:	29 c2                	sub    %eax,%edx
  3d:	8d 04 92             	lea    (%edx,%edx,4),%eax
  40:	29 c1                	sub    %eax,%ecx
  42:	89 ce                	mov    %ecx,%esi
  44:	eb 71                	jmp    b7 <main+0xb7>
  46:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  4d:	8d 76 00             	lea    0x0(%esi),%esi
            semaphor_state = sem_acquire(phNum);
  50:	83 ec 0c             	sub    $0xc,%esp
  53:	53                   	push   %ebx
  54:	e8 b2 03 00 00       	call   40b <sem_acquire>
            semaphor_state = sem_acquire((phNum+4) % 5);
  59:	89 34 24             	mov    %esi,(%esp)
            semaphor_state = sem_acquire(phNum);
  5c:	a3 84 0b 00 00       	mov    %eax,0xb84
            semaphor_state = sem_acquire((phNum+4) % 5);
  61:	e8 a5 03 00 00       	call   40b <sem_acquire>
  ...
  69:	83 ec 04             	sub    $0x4,%esp
            semaphor_state = sem_acquire((phNum+4) % 5);
  6c:	a3 84 0b 00 00       	mov    %eax,0xb84
        printf(WRITE_FD, "Philosopher %d is eating\n", phNum);
  71:	53                   	push   %ebx
  72:	68 2e 08 00 00       	push   $0x82e
  77:	6a 01                	push   $0x1
  ...
  e8:	0f 84 62 ff ff ff    	je     50 <main+0x50>
            semaphor_state = sem_acquire((phNum+4) % 5);
  ee:	83 ec 0c             	sub    $0xc,%esp
  f1:	56                   	push   %esi
  f2:	e8 14 03 00 00       	call   40b <sem_acquire>
            semaphor_state = sem_acquire(phNum);
  f7:	89 1c 24             	mov    %ebx,(%esp)
            semaphor_state = sem_acquire((phNum+4) % 5);
  fa:	a3 84 0b 00 00       	mov    %eax,0xb84
            semaphor_state = sem_acquire(phNum);
  ff:	e8 07 03 00 00       	call   40b <sem_acquire>
 104:	83 c4 10             	add    $0x10,%esp
 107:	e9 5d ff ff ff       	jmp    69 <main+0x69>
...
0000040b <sem_acquire>:
SYSCALL(sem_acquire)
 40b:	b8 17 00 00 00       	mov    $0x17,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret    

00000413 <sem_release>:
SYSCALL(sem_release)
...
free(void *ap)
{
 ...
 671:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 88 0b 00 00    	mov    %edx,0xb88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 88 0b 00 00    	mov    0xb88,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 7e2:	00 00 00 
    if(p->s.size >= nunits){
