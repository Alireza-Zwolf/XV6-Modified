  ...
  17:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  58:	e8 63 08 00 00       	call   8c0 <malloc>
 ...
 13c:	53                   	push   %ebx
 13d:	53                   	push   %ebx
 13e:	68 d8 09 00 00       	push   $0x9d8
 143:	6a 01                	push   $0x1
 145:	e8 46 05 00 00       	call   690 <printf>
            exit();
...
000005c3 <sem_acquire>:
SYSCALL(sem_acquire)
 5c3:	b8 1a 00 00 00       	mov    $0x1a,%eax
 5c8:	cd 40                	int    $0x40
 5ca:	c3                   	ret    

000005cb <sem_release>:
 ...
 5ec:	89 d1                	mov    %edx,%ecx
{
 ...
 619:	0f b6 92 9c 0a 00 00 	movzbl 0xa9c(%edx),%edx
 ...
 699:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6d5:	57                   	push   %edi
 6d6:	56                   	push   %esi
 6d7:	e8 47 fe ff ff       	call   523 <write>
 ...
 709:	ff 24 85 44 0a 00 00 	jmp    *0xa44(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 72e:	e8 f0 fd ff ff       	call   523 <write>
        putc(fd, c);
 ...
 73f:	57                   	push   %edi
 740:	56                   	push   %esi
 741:	e8 dd fd ff ff       	call   523 <write>
        putc(fd, c);
 ...
 7ab:	57                   	push   %edi
 7ac:	56                   	push   %esi
 7ad:	e8 71 fd ff ff       	call   523 <write>
        while(*s != 0){
 ...
 7ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 7ef:	e8 2f fd ff ff       	call   523 <write>
        ap++;
 ...
 817:	90                   	nop
          s = "(null)";
 818:	ba 3c 0a 00 00       	mov    $0xa3c,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 923:	e8 63 fc ff ff       	call   58b <sbrk>
  if(p == (char*)-1)
