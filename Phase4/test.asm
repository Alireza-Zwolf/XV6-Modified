   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  1b:	83 c3 01             	add    $0x1,%ebx
      temp = sem_init(i, 1);
  1e:	e8 60 03 00 00       	call   383 <sem_init>
    for (int i = 0; i < PHILS_COUNT; i++)
  23:	83 c4 10             	add    $0x10,%esp
      temp = sem_init(i, 1);
  26:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    for (int i = 0; i < PHILS_COUNT; i++)
  2b:	83 fb 05             	cmp    $0x5,%ebx
  2e:	75 e5                	jne    15 <main+0x15>
  30:	bb 30 00 00 00       	mov    $0x30,%ebx
  35:	8d 75 e2             	lea    -0x1e(%ebp),%esi
    
    for (int i = 0; i < PHILS_COUNT; i++)
    {
      char id[] = {i + '0', '\0'};
  38:	88 5d e2             	mov    %bl,-0x1e(%ebp)
  3b:	c6 45 e3 00          	movb   $0x0,-0x1d(%ebp)
      char * argv[] = {id};
  3f:	89 75 e4             	mov    %esi,-0x1c(%ebp)
      int pid = fork();
  42:	e8 94 02 00 00       	call   2db <fork>
      if (pid == 0) 
  47:	85 c0                	test   %eax,%eax
  49:	74 2e                	je     79 <main+0x79>
    for (int i = 0; i < PHILS_COUNT; i++)
  4b:	83 c3 01             	add    $0x1,%ebx
  4e:	80 fb 35             	cmp    $0x35,%bl
  51:	75 e5                	jne    38 <main+0x38>
        exec("phil", argv);
        exit();
      }
    }
    for (int i = 0; i < PHILS_COUNT; i++)
      wait();
  53:	e8 93 02 00 00       	call   2eb <wait>
  58:	e8 8e 02 00 00       	call   2eb <wait>
  5d:	e8 89 02 00 00       	call   2eb <wait>
  62:	e8 84 02 00 00       	call   2eb <wait>
  67:	e8 7f 02 00 00       	call   2eb <wait>
      
    return 0;
}
  6c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  6f:	31 c0                	xor    %eax,%eax
  71:	59                   	pop    %ecx
  72:	5b                   	pop    %ebx
  73:	5e                   	pop    %esi
  74:	5d                   	pop    %ebp
  75:	8d 61 fc             	lea    -0x4(%ecx),%esp
  78:	c3                   	ret    
        exec("phil", argv);
  79:	50                   	push   %eax
  7a:	50                   	push   %eax
  7b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  7e:	50                   	push   %eax
  7f:	68 78 07 00 00       	push   $0x778
  84:	e8 92 02 00 00       	call   31b <exec>
        exit();
  89:	e8 55 02 00 00       	call   2e3 <exit>
  8e:	66 90                	xchg   %ax,%ax
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 7d 07 00 00       	mov    $0x77d,%edx
        while(*s != 0){
