   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  1b:	83 c3 01             	add    $0x1,%ebx
      temp = sem_init(i, 1);
  1e:	e8 50 03 00 00       	call   373 <sem_init>
    for (int i = 0; i < PHILS_COUNT; i++)
  23:	83 c4 10             	add    $0x10,%esp
      temp = sem_init(i, 1);
  26:	a3 90 0a 00 00       	mov    %eax,0xa90
    for (int i = 0; i < PHILS_COUNT; i++)
  ...
  3f:	89 75 e4             	mov    %esi,-0x1c(%ebp)
      int pid = fork();
  42:	e8 84 02 00 00       	call   2cb <fork>
      if (pid == 0) 
  47:	85 c0                	test   %eax,%eax
  49:	74 15                	je     60 <main+0x60>
    for (int i = 0; i < PHILS_COUNT; i++)
  ...
  60:	50                   	push   %eax
  61:	50                   	push   %eax
  62:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  65:	50                   	push   %eax
  66:	68 68 07 00 00       	push   $0x768
  6b:	e8 9b 02 00 00       	call   30b <exec>
        exit();
